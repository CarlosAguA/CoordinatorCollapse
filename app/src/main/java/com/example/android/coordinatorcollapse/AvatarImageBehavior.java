package com.example.android.coordinatorcollapse;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    /*
     The way coordinator´s layout sees : en cuáles vistas depende su CircleImageView
     */
    @Override
    ...
    /*
    In this method happens the math. Normally one calculates all the effects that
